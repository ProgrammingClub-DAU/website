...
export const getMockProfile = (userId: string): Profile => {
  return {
    ...
    platformStats: [
      { platform: "Codeforces", solved: 520, handle: "Sumeet.Verma", rating: 1990, maxRating: 1990, contestCount: 42 },
      { platform: "LeetCode", solved: 210, handle: "sumeet_verma", rating: 1850 },
      { platform: "CodeChef", handle: "sumeet_v", rating: 1924 },
      { platform: "AtCoder", handle: "sumeet_v", rating: 1420 },
    ],
